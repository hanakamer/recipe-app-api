...
class PublicIngredientsApiTests(TestCase):
    """Test unautehnticated API requests"""
...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        user2 = create_user(email='user2@example.example.com')
    ...
    def test_filter_ingredients_assingned_to_recipe(self):
        """Test listing ingredients by those assigned to recipes"""
        in1 = Ingredient.objects.create(user=self.user, name='applers')
