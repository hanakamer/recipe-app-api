...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        """test changing the recipe user resulrts in an error"""
    ...
    def test_delete_other_users_recipe_error(self):
        """test rying to delete another users recipe gives error"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        """Test creatin a recipe with new ingredients """
        payload = {
    ...
    def test_create_recip_with_existing_ingredients(self):
    ...
    def test_create_ingredient_on_update(self):
        """test creating an ingredient when updatein a recipe"""
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='eubergine with tahini')
